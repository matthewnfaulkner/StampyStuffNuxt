...
const handleAddProductToCart = (product: ProductVariant) => {
    ...
    <PrimeCard>
        <template #header>
            <div class="grid place-items-center">
                <img :src="props.product.thumbnail" class="w-full h-64 px-6" />
            </div>
        </template>
        <template #subtitle>
            <div class="flex items-center justify-between">
                <div class="space-y-1">
                    ...
                    <h4 class="capitalize">{{ props.product.category }}</h4>
                </div>
